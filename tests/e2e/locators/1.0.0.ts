...
const activityBar = {
    ActionsControl: {
        constructor: (title: string) => By.xpath(`.//li[@title='${title}']`)
    },
    ActivityBar: {
        constructor: By.id('theia-left-content-panel'),
        viewContainer: By.className('p-TabBar-content'),
        label: 'title',
        actionsContainer: By.className('p-TabBar-content'),
        actionItem: By.className('p-TabBar-tab')
    },
    ViewControl: {
        constructor: (title: string) => By.xpath(`.//li[@title='${title}']`),
        attribute: 'class',
...
const editor = {
    EditorView: {
        constructor: By.id('theia-main-content-panel'),
        parent: By.id('theia-left-right-split-panel'),
        settingsEditor: By.id('workbench.editor.settings2'),
        webView: By.id('WebviewEditor'),
        diffEditor: By.className('monaco-diff-editor'),
        tab: By.className('p-TabBar-tab'),
        closeTab: By.className('p-TabBar-tabCloseIcon'),
        tabTitle: 'title',
        tabLabel: 'aria-label'
    },
    Editor: {
...
const menu = {
    ContextMenu: {
        ...
        constructor: By.className('p-Menu-content'),
        itemConstructor: (label: string) => By.xpath(`.//li[div/text()='${label}']`),
        itemElement: By.className('p-Menu-item'),
        itemLabel: By.className('p-Menu-itemLabel'),
        itemText: 'innerText',
        itemNesting: By.className('submenu-indicator')
    },
    TitleBar: {
        constructor: By.id('theia-top-panel'),
        itemConstructor: (label: string) => By.xpath(`.//div[text()='${label}']`),
        itemElement: By.className('p-MenuBar-item'),
        itemLabel: 'innerText',
...
const sideBar = {
    SideBarView: {
        constructor: By.className('p-Panel')
    },
    ViewTitlePart: {
